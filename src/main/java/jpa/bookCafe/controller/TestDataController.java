...
//    @PostConstruct
    ...
    public void createItem(){
        ...
        if(all.size()<=0){
            Item 아메리카노 = itemRepository.save(new Item("아메리카노", 3000, "menu1.jpg", 100, Category.DRINK));
            Item 카페라떼 = itemRepository.save(new Item("카페라떼", 3500, "menu2.jpg", 100, Category.DRINK));
            Item 카페모카 = itemRepository.save(new Item("카페모카", 4000, "menu3.jpg", 100, Category.DRINK));
            Item 딸기스무디 = itemRepository.save(new Item("딸기스무디", 4500, "menu4.jpg", 100, Category.DRINK));
            Item 오렌지주스 = itemRepository.save(new Item("오렌지주스", 2500, "menu5.jpg", 100, Category.DRINK));
            Item 아이스크림_라떼 = itemRepository.save(new Item("아이스크림 라떼", 3500, "menu6.jpg", 100, Category.DRINK));
            Item 유자_아메리카노 = itemRepository.save(new Item("유자 아메리카노", 3500, "menu7.jpg", 100, Category.DRINK));
            itemRepository.save(new Item("아이스 카푸치노", 2500, "menu8.jpg", 100, Category.DRINK));

            Item 라면 = itemRepository.save(new Item("라면", 3500, "food1.png", 100, Category.FOOD));
            itemRepository.save(new Item("불 볶음면", 5000, "food2.png", 100, Category.FOOD));
            itemRepository.save(new Item("불 로제 떢볶이", 5000, "food3.png", 100, Category.FOOD));
            itemRepository.save(new Item("달달구마 떡볶이", 4500, "food4.png", 100, Category.FOOD));
            itemRepository.save(new Item("짜장면", 4000, "food5.png", 100, Category.FOOD));
            itemRepository.save(new Item("매콤 라볶이", 4500, "food6.png", 100, Category.FOOD));
            Item 크림소스_떡볶이 = itemRepository.save(new Item("크림소스 떡볶이", 4500, "food7.png", 100, Category.FOOD));
            itemRepository.save(new Item("오리지널 떡볶이", 4500, "food8.png", 100, Category.FOOD));

            itemRepository.save(new Item("크림치즈 프레즐", 3000, "bakery1.png", 100, Category.BAKERY));
            itemRepository.save(new Item("블루베리/어니언 베이글", 3500, "bakery2.png", 100, Category.BAKERY));
            itemRepository.save(new Item("블루베리/초코바나나 와플", 4000, "bakery3.png", 100, Category.BAKERY));
            itemRepository.save(new Item("초코바나나 와플", 3500, "bakery4.png", 100, Category.BAKERY));
            itemRepository.save(new Item("에그&치즈 크라상 샌드위치", 4000, "bakery5.png", 100, Category.BAKERY));

            List<CartDto> cartDtos = new ArrayList<>();
            cartDtos.add(new CartDto(아메리카노.getId(), 3));
            cartDtos.add(new CartDto(카페라떼.getId(), 2));
            cartDtos.add(new CartDto(카페모카.getId(), 1));

            List<CartDto> cartDtos2 = new ArrayList<>();
            cartDtos2.add(new CartDto(카페라떼.getId(), 2));
            cartDtos2.add(new CartDto(딸기스무디.getId(), 3));

           List<CartDto> cartDtos3 = new ArrayList<>();
            cartDtos3.add(new CartDto(아메리카노.getId(), 3));
            cartDtos3.add(new CartDto(카페라떼.getId(), 2));
            cartDtos3.add(new CartDto(딸기스무디.getId(), 6));
            cartDtos3.add(new CartDto(오렌지주스.getId(), 4));

           List<CartDto> cartDtos4 = new ArrayList<>();

            cartDtos4.add(new CartDto(크림소스_떡볶이.getId(), 5));
            cartDtos4.add(new CartDto(카페라떼.getId(), 5));
            cartDtos4.add(new CartDto(딸기스무디.getId(), 2));
            cartDtos4.add(new CartDto(아이스크림_라떼.getId(), 5));
            cartDtos4.add(new CartDto(유자_아메리카노.getId(), 4));
            cartDtos4.add(new CartDto(오렌지주스.getId(), 2));
            cartDtos4.add(new CartDto(라면.getId(), 2));

          List<CartDto> cartDtos5 = new ArrayList<>();
            cartDtos5.add(new CartDto(라면.getId(), 2));
            cartDtos5.add(new CartDto(카페라떼.getId(), 1));
            cartDtos5.add(new CartDto(딸기스무디.getId(), 1));
            ...
            Long orderId4 = orderService.주문하기(cartDtos4);
            Long orderId5 = orderService.주문하기(cartDtos5);
            ...
            approveResponse.setTid(UUID.randomUUID().toString());
            approveResponse.setItem_name("아메리카노 외 2건");
            ...
            approveResponse2.setTid(UUID.randomUUID().toString());
            approveResponse2.setItem_name("카페라떼 외 1건");
            ...
            approveResponse3.setTid(UUID.randomUUID().toString());
            approveResponse3.setItem_name("아메리카노 외 3건");
            ...
            approveResponse4.setTid(UUID.randomUUID().toString());
            approveResponse4.setItem_name("크림소스_떡볶이 외 7건");
            ...
            approveResponse5.setTid(UUID.randomUUID().toString());
            approveResponse5.setItem_name("라면 외 2건");
